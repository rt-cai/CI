...
public:
   ...
   * This function will call helper function buildTree.
    ...
    */
   PNG render();
   void getColor(Node* croot, vector<vector<HSLAPixel*>> pixels);
   ...
   * You may want a recursive helper function for this one.
   ...
   bool isWithinTol(Node* root, double tol, HSLAPixel avgP);
...
private:
  ...
  pair<int,int> getCenter(PNG* imIn, int k);
  PNG* subImage(PNG* orig, int x, int y, int newK);
  double avgEntropy(PNG* imIn, pair<int,int> se, stats stat);
